...
public class EpostaGrubu
{
    ...
    public string GrupTipi { get; set; } = string.Empty; // NORMAL, STATIK, DINAMIK, DEBIS
    public string? ViewAdi { get; set; } // DINAMIK/STATIK gruplar için view/dosya adı
    ...
    public int UyeSayisi { get; set; } // Grup üye sayısı (STATIK: trigger günceller, DINAMIK: backend hesaplar)
