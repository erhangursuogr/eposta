...
('EMAIL_IMZA', 'GENEL_DUYURU_IMZASIZ', '','Genel duyurular - imza yok','N', 'Y');
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="footer-table"
       style="margin-top:40px; border-top: 1px solid #e1e1e1; padding-top: 20px; font-family: Arial, Helvetica, sans-serif;">
    <tr>
        <!-- Sol Logo -->
        <td valign="middle" class="footer-col footer-logo" style="width: 100px; text-align: left;">
            <img src="https://www.deu.edu.tr/file/2019/01/logo.png" 
                 alt="DEÜ Logo" width="200" style="display:block; border:0;">
        </td>

        <!-- Orta Metin -->
        <td valign="top" class="footer-col footer-text"
            style="text-align: center; color: #333333; font-size: 13px; line-height: 1.5;">
            <strong style="font-size: 15px; color: #1a4f8b;">Dokuz Eylül Üniversitesi Rektörlüğü</strong><br>
            <a href="https://www.deu.edu.tr" style="color:#1a4f8b; text-decoration:none;">www.deu.edu.tr</a> |
            <a href="tel:+902324121212" style="color:#1a4f8b; text-decoration:none;">+90 (232) 412 12 12</a>
        ...
        <!-- Sağ Logo -->
        <td valign="middle" class="footer-col footer-logo" style="width: 100px; text-align: right;">
            <img src="https://www.deu.edu.tr/file/2019/01/logo.png" 
                 alt="DEÜ Sağ Logo" width="200" style="display:block; border:0; margin-left:auto;">
        </td>
    </tr>
...
', 'DEÜ Rektörlük duyuru imzası', 'N', 'Y',0);

INSERT INTO SISTEM_AYARLARI (AYAR_KATEGORI, AYAR_ANAHTAR, AYAR_DEGER, AYAR_ACIKLAMA, GIZLI, AKTIF, GOREV_YERI) VALUES
('EMAIL_IMZA', 'REKTOR', '<br/><br/><p style="margin-top:20px;padding-top:10px;border-top:1px solid #ccc;font-size:12px;color:#666;">Prof.Dr. Bayram YILMAZ<br/>Dokuz Eylül Üniversitesi</p>', 'Rektör duyuru imzası', 'N', 'Y',0);

INSERT INTO SISTEM_AYARLARI (AYAR_KATEGORI, AYAR_ANAHTAR, AYAR_DEGER, AYAR_ACIKLAMA, GIZLI, AKTIF, GOREV_YERI) VALUES
('EMAIL_IMZA', 'BID', '<br/><br/><p style="margin-top:20px;padding-top:10px;border-top:1px solid #ccc;font-size:12px;color:#666;">Saygılarımızla,<br/>Dokuz Eylül Üniversitesi<br/>Bilgi İşlem Dairesi</p>', 'Bilgi İşlem duyuru imzası', 'N', 'Y',0);
...
'<div style="font-family: Arial, sans-serif; font-size: 12px; color: #333; margin-top: 20px; padding-top: 10px; border-top: 1px solid #ccc;">
  ...
  <p style="margin: 5px 0;">Tel: (232) 301 7211 – 7212 – 7213 | muhendislik@deu.edu.tr</p>
</div>',
...
('EMAIL_IMZA', 'TIP',
'<div style="font-family: Arial, sans-serif; font-size: 12px; color: #333; margin-top: 20px; padding-top: 10px; border-top: 1px solid #ccc;">
  <p style="margin: 5px 0;"><strong>Tıp Fakültesi Dekanlığı</strong></p>
  <p style="margin: 5px 0;">Dokuz Eylül Üniversitesi</p>
...
INSERT INTO KULLANICILAR (KULLANICI_ADI, AD_SOYAD, EMAIL, ROL_ID, AKTIF, OLUSTURMA_TARIHI) VALUES
('emine.altinkaynakabda', 'Manager Kullanıcı', 'emine.altinkaynakabda@deu.edu.tr', (SELECT ID FROM ROLLER WHERE ROL_KODU = 'MANAGER'), 'Y', SYSDATE);
