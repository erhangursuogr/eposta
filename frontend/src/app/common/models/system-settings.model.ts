...
export const CATEGORY_CONFIG: Record<string, { displayName: string; icon: string; color: string; order: number }> = {
  ...
  'EMAIL_PERSONEL': { displayName: 'Personel Email Ayarları', icon: 'badge', color: 'accent', order: 2 },
  'EMAIL_REKTORLUK': { displayName: 'Rektörlük Email Ayarları', icon: 'school', color: 'warn', order: 3 },
  'EMAIL_OGRENCI': { displayName: 'Öğrenci Email Ayarları', icon: 'school', color: 'primary', order: 4 },
